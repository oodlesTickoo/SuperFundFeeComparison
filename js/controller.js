app.controller("TTRController", ['$scope', '$timeout', 'AgeCalculator', 'ChartServiceHc', 'DonutChartServiceHc', 'PdfMaker', function($scope, $timeout, AgeCalculator, ChartServiceHc, DonutChartServiceHc, PdfMaker) {
    ...
    $scope.calculateFinal = function(isValid) {
        ...
        if (isValid) {
            ...
            $scope.resultFundOne = fundCalculation(netReturn, $scope.fundA, $scope.fundNotFoundA)[1];
            $scope.resultFundTwo = fundCalculation(netReturn, $scope.fundB, $scope.fundNotFoundB)[1];

            $scope.resultFundOneArray = fundCalculation(netReturn, $scope.fundA, $scope.fundNotFoundA)[0];
            $scope.resultFundTwoArray = fundCalculation(netReturn, $scope.fundB, $scope.fundNotFoundB)[0];
