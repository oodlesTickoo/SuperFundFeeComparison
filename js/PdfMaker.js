...
var options = {
  theme : 'grid'
        // margin: {top: 380}
          ...
          doc.setFontSize(12);
          doc.text(40,55,"1) Salary indicated here does not include superannuation guarantee contribution, fringe benefit or\nnon-standard agreed employment benefit,  and is the salary before any salary sacrifice.");
          doc.text(40,85,"2) SGC will gradually increase to 12.00% in the future.");
          doc.text(40,100,"3) It is assumed that at least the minimum take-home(after salary sacrifice and tax) wage is required\nby the member.");
          doc.text(40,130,"4) It is assumed that the superannuation balance is boosted up by the net concessional contribution\nin the financial year.");
          doc.text(40,160,"5) This calculator takes into the consideration of both the personal tax and concessional contribution\ntax charged from the super.");
          doc.text(40,190,"6) It is assumed that the member will contribute (including superannuation guarantee contribution\nand salary sacrifice) up to the maximum concessional contribution cap in a financial year.");
          doc.addImage(imgData2,'PNG',40,780);
          doc.setFontSize(10);
